...
Pod::Spec.new do |s|
  ...
  s.vendored_libraries = 'ios/libs/libOpenFace_engine.a'
  ...
  s.pod_target_xcconfig = {
    ...
    "OTHER_LDFLAGS" => "-force_load \"${PODS_TARGET_SRCROOT}/ios/libs/libOpenFace_engine.a\"",
